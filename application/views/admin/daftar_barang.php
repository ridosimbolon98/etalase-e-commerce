...
<head>
  ...
  <title>Admin Jualin Id | Daftar Barang</title>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <?php foreach ($barang as $row) { ?>  
            <tr>
              ...
              <td>
                <a href="<?= base_url(); ?>admin/detailBarang/<?= $row->id; ?>"><i class="fa fa-eye"></i> </a>
              </td>
              <td>
                <a href="<?= base_url(); ?>admin/editBarang/<?= $row->id; ?>"><i class="fa fa-edit text-success"></i> </a>
              </td>
            </tr>
          <?php } ?>
        </table>
